...
function showJoke(){
    const joketext = getRandomData('jokes');
  ...
  function showQuote(){
     const joketext = getRandomData('quotes');
    const container = document.querySelector('.quote-content');
    const quote = document.createElement('p');
      const author = document.createElement('p');
  
    quote.textContent = joketext.quote;
    author.textContent =  "- " + joketext.author ;
    clearAll();
  ...
  function showRiddle(){
    ...
    const con = document.querySelector('.riddle-content');
  
    clearAll();
      con.appendChild(questionele);
  
    con.appendChild(answerele);
    
  }
  function revealAnswers(){
    const r= document.querySelector('.riddle-content');
    const rid = r.querySelector('p');
    const rans= document.querySelector('#riddle-answer');
    if(rid && rans.hidden){
      rans.hidden = false;
    }
    else if(rid){
      alert("the anser is thers dumbfuck")
    }
    else{
      alert("There is no riddle to reveal to !")
    }
